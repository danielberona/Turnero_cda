...
export default function PantallaTV() {
  ...
  // ── Styles ──────────────────────────────────────────────────
  const S = {
    root:  { width: '100vw', height: '100vh', overflow: 'hidden', background: '#F8DE22', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" },
    stage: { width: 1920, height: 1080, flexShrink: 0, transformOrigin: 'center', background: '#F8DE22', padding: '56px 56px 48px', display: 'grid', gridTemplateRows: 'auto 1fr auto', gap: 36 },
